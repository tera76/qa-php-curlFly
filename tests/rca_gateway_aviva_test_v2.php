...
$testCallresponseJsonAndCode = post_save_quotations_aviva($baseUrl ,$customerCode, $token, $quotationId);
$testCallresponse = $testCallresponseJsonAndCode['responseJson'];
$testCallresponseCode = $testCallresponseJsonAndCode['responseCode'];
...
*/
$testCallresponseJsonAndCode = get_documents_attachment($baseUrl ,$customerCode, $token,"aviva","attachment_3");
$testCallresponse = $testCallresponseJsonAndCode['responseJson'];
$testCallresponseCode = $testCallresponseJsonAndCode['responseCode'];
...
$testCallresponseJsonAndCode = get_documents_attachment($baseUrl ,$customerCode, $token,"aviva","attachment_4");
$testCallresponse = $testCallresponseJsonAndCode['responseJson'];
$testCallresponseCode = $testCallresponseJsonAndCode['responseCode'];
...
$testCallresponseJsonAndCode = get_documents_attachment($baseUrl ,$customerCode, $token,"aviva","attachment_4_ter");
...
$testCallresponseJsonAndCode = get_documents_attachment($baseUrl ,$customerCode, $token,"aviva","company_informative_privacy");
...
*/
$testCallresponseJsonAndCode = get_tnc_broker($baseUrl ,$customerCode, $token, $savedQuotationId, "aviva","CONSISTENCY_QUESTIONNAIRE","false");
$testCallresponse = $testCallresponseJsonAndCode['responseJson'];
$testCallresponseCode = $testCallresponseJsonAndCode['responseCode'];
...
$testCallresponseJsonAndCode = get_tnc_broker($baseUrl ,$customerCode, $token, $savedQuotationId, "aviva","TERM_AND_CONDITION","false");
$testCallresponse = $testCallresponseJsonAndCode['responseJson'];
$testCallresponseCode = $testCallresponseJsonAndCode['responseCode'];
...
*/
$testCallresponseJsonAndCode = get_tnc_broker($baseUrl ,$customerCode, $token, $savedQuotationId, "aviva","CONSISTENCY_QUESTIONNAIRE","true");
$testCallresponse = $testCallresponseJsonAndCode['responseJson'];
$testCallresponseCode = $testCallresponseJsonAndCode['responseCode'];
...
$testCallresponseJsonAndCode = get_tnc_broker($baseUrl ,$customerCode, $token, $savedQuotationId, "aviva","TERM_AND_CONDITION","true");
$testCallresponse = $testCallresponseJsonAndCode['responseJson'];
$testCallresponseCode = $testCallresponseJsonAndCode['responseCode'];
